    ...
    addBlock(transaction, senderPublicKey, signature) {
        ...
        if (isValid) {
            ...
            newInstance.save((err) => {
                if (err)
                    return console.log("Erro ao salvar", err.message);
...
const iskandar = new Wallet;
arthur.sendInfo('0000', sieg.publicKey);
sieg.sendInfo('1252', iskandar.publicKey);
iskandar.sendInfo('2015', arthur.publicKey);
